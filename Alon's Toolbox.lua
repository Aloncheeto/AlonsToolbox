...
interface:slider("Online Menu Colours", {"In hue, obviously"}, "In hue, obviously", 0, 360, 0, 1, function(amount)
    MENUHUE = amount
end)
--EXPERIMENT START--
experiment:action("Cat Create", {}, "Testing ", function() entities.create_ped(1, util.joaat("a_c_cat_01"), players.get_position(players.user() ), 0)  end) --n
